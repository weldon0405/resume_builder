      ...
      <div className="space-y-4">
        ...
        {isAnalyzing && (
          <div className="space-y-2">
            ...
            <Progress value={45} className="h-2 w-full bg-gray-100" indicatorClassName="bg-teal-600" />
          </div>
        )}
              ...
              <div className="space-y-3">
                {keySkills.map((skill) => (
                  <div key={skill.name} className="space-y-1">
                    ...
                    <Progress value={skill.match} className="h-2 w-full bg-gray-100" indicatorClassName="bg-teal-600" />
                  </div>
                ))}
              </div>
            </div>
